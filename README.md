...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/holy-fire-4514)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/holy-fire-4514
```

A live public deployment of this template is available at [https://holy-fire-4514.templates.workers.dev](https://holy-fire-4514.templates.workers.dev)
